...
export const metadata: Metadata = {
  title: "Blog — Bank Statement Parsing Guides | PDF, CSV, Excel, Scanned & Photos",
  description:
    "Learn how to convert PDF bank statements, CSV and Excel spreadsheets, scanned documents, and photos from TD, RBC, BMO, Scotiabank, CIBC, Chase, Bank of America, and Wells Fargo to categorized CSV or Excel exports.",
  alternates: { canonical: "https://bankread.ai/blog" },
  openGraph: {
    title: "BankRead Blog — Bank Statement Parsing Guides | PDF, CSV, Excel, Scanned & Photos",
    description:
      "Step-by-step guides for converting bank statement PDFs, CSV and Excel spreadsheets, scanned documents, and photos to categorized CSV and Excel exports. Covers TD, RBC, BMO, Scotiabank, CIBC, Chase, Bank of America, and Wells Fargo.",
  ...
  twitter: {
    ...
    title: "BankRead Blog — Bank Statement Parsing Guides | PDF, CSV, Excel, Scanned & Photos",
    description:
      "Step-by-step guides for converting bank statement PDFs, CSV and Excel spreadsheets, scanned documents, and photos to categorized CSV and Excel exports.",
  },
};
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 w-full">
        ...
        <p className="text-lg text-gray-600 mb-10">
          Guides for converting bank statement PDFs, CSV and Excel spreadsheets, scanned documents, and photos to categorized exports.
        </p>
